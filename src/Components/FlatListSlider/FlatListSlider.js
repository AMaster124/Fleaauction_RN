...
export default class FlatListSlider extends Component {
  ...
  static defaultProps = {
    ...
    imageKey: 'image',
    local: false,
    parentWidth: Math.round(Dimensions.get('window').width),
  ...
  componentDidUpdate(prevprops) {
    ...
    // }
    if ( prevprops.scrollNext != this.props.scrollNext && this.props.scrollNext ) {
  ...
  render() {
    ...
    const mW = Math.round(Dimensions.get('window').width)
    ...
    return (
      <View>
        <FlatList
          ...
          style={{
            paddingHorizontal: ((this.props.parentWidth ? this.props.parentWidth : mW )-itemWidth)/2,
          }}
          ListFooterComponent={<View style={{marginLeft: (this.props.parentWidth ? this.props.parentWidth : mW )-itemWidth}}/>}
        />
